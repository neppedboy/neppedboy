...
<span style="font-size: 30px">
  </br>Всех приветствую! Это моя страница на Github. Я тут публикую всякие коды, программки или ещё всякое, что я нахожу.</br>
  </br>Тут не особо будет чего-то интересного, просто страница для работы.</br>
  </br>Я работаю на своём проекте: NeppedCord</br>
            </br>Это сервер в Дискорде для спокойного и доброго общения</br>
            </br>Так-же, это проект по созданию ПО, программ или ботов.</br>
</span>
